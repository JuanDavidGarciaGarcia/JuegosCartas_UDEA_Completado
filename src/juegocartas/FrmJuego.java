...
public class FrmJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTotalPuntaje = new javax.swing.JButton();
        ...
        btnTotalPuntaje.setText("Puntos");
        btnTotalPuntaje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTotalPuntajeActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(btnRepartir, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addComponent(btnTotalPuntaje, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnRepartir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnTotalPuntaje, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(18, 18, 18)
                .addComponent(tpJugadores))
        );
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        switch (pestaña) {
            case 0:
                ...
                mensajeEscalera=jugador1.Escalera();
                break;
            case 1:
                mensaje=jugador2.getGrupos();
                mensajeEscalera=jugador2.Escalera();
                break;
        }
        JOptionPane.showMessageDialog(null, mensaje + "\n" +mensajeEscalera);
    }//GEN-LAST:event_btnVerificarActionPerformed

    private void btnTotalPuntajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTotalPuntajeActionPerformed
        int pestaña = tpJugadores.getSelectedIndex();
        String mensaje = "";
        switch (pestaña) {
            case 0:
    ...
    }//GEN-LAST:event_btnTotalPuntajeActionPerformed
    ...
    private javax.swing.JButton btnTotalPuntaje;
